    ...
    public function safeUp()
    {
        ...
        if ($check_customer_order === null) {
            ...
            $this->createTable('customer_order', [
                ...
                'status' => $this->tinyInteger(0)->null()->defaultValue(0)->comment('"0: chưa hoàn thành, 1: hoàn thành"'),
            ...
            $this->addForeignKey('fk_customer_order_co_so_customer_co_so', 'customer_order', 'co_so', 'customer_co_so', 'id', 'RESTRICT', 'CASCADE');
